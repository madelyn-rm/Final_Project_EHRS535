...
This flexdashboard presents an insightful exploration of the National Park species data through three distinct visualizations. At the center, an interactive plot invites users to delve into the top 10 non-native species across various National Parks, by clicking on the various points depicting the location of each park. To the top right, a detailed scatter plot highlights the correlation between non-native species prevalence and visitor impact, emphasizing the ecological and anthropogenic factors affecting these protected areas. Lastly, the bottom left corner features a comprehensive heat map, illustrating the distribution patterns of invasive species across the these parks. Together, these visualizations aim to inform and emphasize the complex relationships between biodiversity, conservation, and anthropogenic influences in the National Parks.
