...
ggplot(et_nn_species_single, aes(x = et_count, y = nn_count, size = avg_visits,
  ...
  theme_classic()+
  labs(
    title = "Non-Native Species and Visitor Impact",
    x = "Endangered/Threatened/Extinct Count",
    y = "Non-Native Count")+
  theme(
    axis.text.x = element_text(size = 15),  # Rotate and increase size of x-axis labels
    axis.text.y = element_text(size = 15),  # Increase size of y-axis labels
    plot.title = element_text(hjust = 0.5, size = 30),  # Center and enlarge title
    axis.title.x = element_text(size = 25),
    axis.title.y = element_text(size = 25),# Increase size of x-axis title
