...
server <- function(input, output, session) {
  ...
  output$top_species_table <- renderTable({
    ...
    nps_with_coord %>%
      ...
      mutate(CommonNames = str_split(CommonNames, ",", simplify = TRUE)[, 1])
  })
}
...
>>>>>>> e8e7e902b7a65f8fa177ce93ac38c1b5c9f28c36
...
### Distribution of Invasive Species Across National Parks
